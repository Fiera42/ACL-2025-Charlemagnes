<template>
  <div class="tag-selector">
    ...
    <div 
      ...
      class="text-center py-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors group"
      @click="$emit('create')"
    >
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-auto mb-2 text-gray-400 group-hover:text-indigo-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
      </svg>
      <p class="text-sm text-gray-500 group-hover:text-gray-700">Aucun tag disponible</p>
      <p class="text-xs text-gray-400 mt-1 group-hover:text-indigo-500">Cliquez ici pour en ajouter !</p>
    </div>
