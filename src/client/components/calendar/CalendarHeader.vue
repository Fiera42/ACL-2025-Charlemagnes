    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex items-center gap-2">
        <select
            ...
            class="px-3 py-1 text-lg font-semibold text-gray-900 bg-white border border-gray-300 rounded-lg hover:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
        >
        ...
        <button
            @click="resetToToday"
            class="ml-2 p-2 text-gray-600 hover:text-indigo-600 hover:bg-gray-100 rounded-lg transition-colors"
            title="Retour à aujourd'hui"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
                d="M10 5C10 4.44772 9.55228 4 9 4C8.44772 4 8 4.44772 8 5V11C8 11.5523 8.44772 12 9 12H14C14.5523 12 15 11.5523 15 11C15 10.4477 14.5523 10 14 10H10V5Z"
                fill="currentColor"/>
            <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M9 2C4.58172 2 1 5.58172 1 10C1 14.4183 4.58172 18 9 18C13.4183 18 17 14.4183 17 10C17 5.58172 13.4183 2 9 2ZM3 10C3 6.68629 5.68629 4 9 4C12.3137 4 15 6.68629 15 10C15 13.3137 12.3137 16 9 16C5.68629 16 3 13.3137 3 10Z"
                  fill="currentColor"/>
          </svg>
        </button>
      </div>
...
const emit = defineEmits(['changeView', 'newEvent', 'goToToday', 'dateChange']);

const months = ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];

const selectedDay = ref(props.currentDate.getDate());
...
const emitDateChange = () => {
  const newDate = new Date(selectedYear.value, selectedMonth.value, selectedDay.value);
